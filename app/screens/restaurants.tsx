...
const styles = StyleSheet.create({
    ...
    filtersContainer: { marginBottom: 20, backgroundColor: '#fff', padding: 10, borderRadius: 5 },
    ...
    card: { backgroundColor: '#fff', borderRadius: 8, padding: 15, marginBottom: 15, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 5 },
    cardHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
    restaurantName: { fontSize: 18, fontWeight: 'bold' },
    ratingContainer: { flexDirection: 'row', alignItems: 'center' },
    ratingText: { marginLeft: 5, fontSize: 16 },
    typeCuisine: { fontSize: 16, marginBottom: 5 },
    address: { fontSize: 14, color: '#555', marginBottom: 5 },
    statusText: { fontSize: 14, marginBottom: 5 },
    openText: { color: 'green', fontWeight: 'bold' },
    closedText: { color: 'red', fontWeight: 'bold' },
    telephone: { fontSize: 14, color: '#555', marginBottom: 5 },
    description: { fontSize: 14, color: '#333', marginBottom: 10 },
    orderButton: { backgroundColor: '#ff6347', padding: 10, borderRadius: 5, alignItems: 'center' },
